...
CN_EQUITIES_MINUTES_PER_DAY = 242
    ...
    def test_adjust_non_trading_minutes(self):
        ...
        self.assertEqual(
            self.reader.get_value(sid,
                                  Timestamp('2020-01-07 07:01:00', tz='UTC'),
                                  'open'), 242)
        self.assertEqual(
            self.reader.get_value(sid,
                                  Timestamp('2020-01-08 07:01:00', tz='UTC'),
                                  'open'), 484)

        with self.assertRaises(NoDataOnDate):
            self.reader.get_value(sid, Timestamp('2020-01-08', tz='UTC'),
                                  'open')

        # with self.assertRaises(NoDataOnDate):
        #     self.reader.get_value(
        #         sid,
        #         Timestamp('2020-01-08 07:02:00', tz='UTC'),
        #         'open'
        #     )
    @pytest.mark.skip
